...
export default function AddNewDiscussion({
  ...
  const submitNewDiscussion = async (
    ...
    if (response.data.message == "OK") {
      ...
      let newDiscussion: Discussion = {
        ...
        content:
          retrieveData.content.length > 300
            ? retrieveData.content.slice(0, 297) + "..."
            : retrieveData.content,
  ...
  return (
    <div
      className="fixed top-0 z-30 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 "
    ...
    >
      <div className="bg-white flex flex-col items-center shadow-md rounded-md p-5 w-3/5">
        ...
        <form
          className="pt-3 w-4/5"
          method="POST"
          onSubmit={(e) => (
            e.preventDefault(),
            submitNewDiscussion(judulInput, uraianInput, keywordsInput)
          )}
        >
          <div className="pb-5">
          ...
          <div className="pb-5">
            ...
            <textarea
              className="mt-2 w-full p-1 rounded-md border border-gray-400 resize-none"
              value={uraianInput}
          ...
          <div className="pb-5">
            ...
            />
            <p>
              Tuliskan beberapa kata kunci pertanyaan Anda di sini dengan tanda
              koma sebagai pemisah. Maksimal 6 kata kunci yang bisa ditambahkan.
            </p>
