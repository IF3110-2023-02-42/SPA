...
export default function Verification() {
  ...
  function modifyCard(id: string, status: string) {
    ...
    const indexOfCardToModify = newVerificationCards.findIndex(
      (card) => card.ID_Pengguna === id
    );
            ...
            <div className="w-full flex flex-col items-center pb-5 overflow-hidden">
              {verificationCards.map((verification) => (
                <VerificationCard
                  ...
                  tanggalPengajuan={formatDate(
                    verification.tanggalPengajuan.split(" ")[0]
                  )}
