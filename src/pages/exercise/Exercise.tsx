...
const Exercise = () => {
    ...
    const qElements = q.map((el) => (
        <div className="w-[90%] bg-[white] flex flex-col ml-[5%] mb-[2%] rounded-[15px] p-[1.5%] text-[#4D2C5E] [box-shadow:rgba(0,_0,_0,_0.15)_1.95px_1.95px_2.6px]">
                ...
                <div className="flex flex-row">
                    <input className="ml-[2%]" type="radio" name={el.ID_Soal} value={el.jawaban_benar}></input>
                    <label className="ml-[2%]">{el.jawaban_benar}</label>
                </div>
                <div className="flex flex-row">
                    <input className="ml-[2%]" type="radio" name={el.ID_Soal} value={el.jawaban_salah[0]}></input>
                    <label className="ml-[2%]">{el.jawaban_salah[0]}</label>
                </div>
                <div className="flex flex-row">
                    <input className="ml-[2%]" type="radio" name={el.ID_Soal} value={el.jawaban_salah[1]}></input>
                    <label className="ml-[2%]">{el.jawaban_salah[1]}</label>
                </div>
                <div className="flex flex-row">
                    <input className="ml-[2%]" type="radio" name={el.ID_Soal} value={el.jawaban_salah[2]}></input>
    ...
    <main>
        ...
        <body className="h-screen items-center pl-[2.5%] pr-[2.5%] py-[1%] bg-[#fdf8ee] relative">
            <h1 className="text-[#4D2C5E] text-[2rem] font-bold mb-[3%]">Exercise</h1>
            {qElements}
